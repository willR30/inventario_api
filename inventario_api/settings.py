...
ALLOWED_HOSTS = ['https://polaris-invoice-inventory.vercel.app','https://willtech.site/polaris/']
...
EMAIL_USE_TLS = False  # True si usas TLS
EMAIL_USE_SSL = True  # True si usas SSL
